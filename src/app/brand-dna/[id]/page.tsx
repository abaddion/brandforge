  ...
  if (!profile) {
    return (
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-3xl font-bold mb-4">Brand Profile Not Found</h1>
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-4xl font-bold">Brand DNA Profile</h1>
          <div className="flex items-center gap-2">
            <span className="text-sm text-gray-400">Confidence Score:</span>
            <span className="text-2xl font-bold text-accent-gold">{confidence_score}%</span>
          </div>
        </div>
        <a 
          href={profile.url} 
      ...
      <div className="card mb-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-300">{brandDNA.voice.language_style}</p>
          </div>
        </div>
      </div>
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-gray-300">{brandDNA.positioning.category}</p>
            </div>
            <div>
              <h3 className="font-semibold text-primary mb-1">Unique Value</h3>
              <p className="text-gray-300">{brandDNA.positioning.unique_value}</p>
            </div>
            <div>
              <h3 className="font-semibold text-primary mb-1">Differentiation</h3>
              <p className="text-gray-300">{brandDNA.positioning.competitors_differentiation}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <p className="text-gray-300">{brandDNA.target_audience.demographics}</p>
          </div>
          <div>
            <h3 className="font-semibold text-primary mb-2">Psychographics</h3>
            <p className="text-gray-300">{brandDNA.target_audience.psychographics}</p>
          </div>
          <div>
      ...
      <div className="card mb-8">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-300">{brandDNA.visual_identity.color_psychology}</p>
          </div>
          <div>
            <h3 className="font-semibold text-primary mb-2">Design Style</h3>
            <p className="text-gray-300">{brandDNA.visual_identity.design_style}</p>
          </div>
          <div>
      ...
      <div className="card bg-gradient-primary">
        <h2 className="text-2xl font-bold mb-4">Ready to create campaigns?</h2>
